...
<jsp:useBean id="employee" class="vo.RegistrationVO" />

<%-- <jsp:useBean id= "Login" scope= "page | request | session | application" class= "packageName.className" type= "packageName.className" beanName="packageName.className | <%= expression %>" > --%>
<%-- </jsp:useBean> --%>
<!doctype html>
<html lang="en">
<head>
...
<title><jsp:getProperty name="employee" property="firstname" /></title>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4"> 
                    ...
                    <div class="sidebar">
                      ...
                      <form  action="<%=request.getContextPath() %>/UserProfile?flag=update&ID=${i.userID}" method="post">
                      <div class="sidebar-information">
                      <ul class="single-category" >
                          <li class="row">
                            <h6 class="title col-xs-6">First Name</h6>
                            <span class="subtitle col-xs-6"><a href="<%=request.getContextPath() %>/UserProfile?flag=update&Name=${i.firstName}" id="firstname" class="x-editable" data-placement="right" data-type="text" data-pk="1" data-placement="left" data-placeholder="Required" data-original-title="Enter your firstname">
					    ...
					    <li class="row">
                          ...
                          <li class="row">
                            ...
                            <span class="subtitle col-xs-6"><a href="javascript:;" id="event" class="x-editable" data-placement="right"  data-type="combodate" data-template="D MMM YYYY" data-format="YYYY-MM-DD" data-viewformat="MMM D, YYYY" data-pk="1" data-original-title="Select Month and year ">
									</a></span></li>
						<li class="row">
						...
						<li class="row">
                          ...
                          <li class="row">
                            ...
                            <span class="subtitle col-xs-6"><a href="javascript:;" id="group" data-type="select" data-pk="1" data-value="5" data-source="/groups" data-original-title="Select group">
									Admin </a></span></li>
                          <li class="row">
              ...
              <div id="blog-tab" class="tab-pane fade">
                <div class="profile-main">
                  ...
                  <div class="profile-in">
                    <div class="row">
                      <div class="col-md-12">
                        <article class="uou-block-7f"> <img src="User/img/blog-image-1.jpg" alt="" class="thumb">
                        ...
                        <article class="uou-block-7f"> <img src="User/img/blog-image-2.jpg" alt="" class="thumb">
                          <div class="meta"> <span class="time-ago">3 days ago</span> <span class="category">Posted in: <a href="#">Design</a></span> <a href="#" class="comments">12 Comments</a> </div>
                          <h1><a href="#">Perspiciatis Sint Pariatur Velit Corrupti</a></h1>
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.
                            Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.
                        ...
                        <article class="uou-block-7f"> <img src="User/img/blog-image-3.jpg" alt="" class="thumb">
                          <div class="meta"> <span class="time-ago">3 days ago</span> <span class="category">Posted in: <a href="#">Design</a></span> <a href="#" class="comments">12 Comments</a> </div>
                          <h1><a href="#">Perspiciatis Sint Pariatur Velit Corrupti</a></h1>
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.
                            Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.
                        ...
                        <article class="uou-block-7f"> <img src="User/img/blog-image-4.jpg" alt="" class="thumb">
                          <div class="meta"> <span class="time-ago">3 days ago</span> <span class="category">Posted in: <a href="#">Design</a></span> <a href="#" class="comments">12 Comments</a> </div>
                          <h1><a href="#">Perspiciatis Sint Pariatur Velit Corrupti</a></h1>
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.
                            Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.
                        ...
                        <article class="uou-block-7f"> <img src="User/img/blog-image-5.jpg" alt="" class="thumb">
                          <div class="meta"> <span class="time-ago">3 days ago</span> <span class="category">Posted in: <a href="#">Design</a></span> <a href="#" class="comments">12 Comments</a> </div>
                          <h1><a href="#">Perspiciatis Sint Pariatur Velit Corrupti</a></h1>
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.
                            Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.
                        ...
                        <li>
                          <div class="row">
                            <div class="col-xs-4"> 
                              ...
                              <!-- Name -->
                              <div class="fol-name">
                                <div class="avatar"> <img src="User/images/sm-avatar.jpg" alt=""> </div>
...
<div class="uou-block-4e">
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-6"> <a href="#" class="logo"><img src="User/images/logo.png" alt=""></a>
        <ul class="contact-info has-bg-image contain" data-bg-image="User/images/footer-map-bg.png">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <ul class="photos-list">
          <li><img src="User/images/photostream4.jpg" alt=""></li>
          <li><img src="User/images/photostream6.jpg" alt=""></li>
          <li><img src="User/images/photostream3.jpg" alt=""></li>
          <li><img src="User/images/photostream2.jpg" alt=""></li>
          <li><img src="User/images/photostream1.jpg" alt=""></li>
          <li><img src="User/images/photostream.jpg" alt=""></li>
        </ul>
      </div>
      <div class="col-md-3 col-sm-6">
        <h5>Newsletter</h5>
...
<script src="User/js/jquery-2.1.3.min.js"></script> 
<script src="User/js/bootstrap.js"></script> 
<script src="User/js/plugins/superfish.min.js"></script> 
<script src="User/js/jquery.ui.min.js"></script> 
<script src="User/js/plugins/rangeslider.min.js"></script> 
<script src="User/js/plugins/jquery.flexslider-min.js"></script> 
<script src="User/js/uou-accordions.js"></script> 
<script src="User/js/uou-tabs.js"></script> 
<script src="User/js/plugins/select2.min.js"></script> 
<script src="User/js/owl.carousel.min.js"></script> 
<script src="User/js/gmap3.min.js"></script> 
...
jQuery(document).ready(function() {
	...
	//FormEditable.init();
	 ...
	 $('#firstname').click(function() {
		...
		$("#firstname a[href='${pageContext.request.contextPath}/UserProfile?flag=update&Name=${i.firstName}']").attr('href', '${pageContext.request.contextPath}/UserProfile?flag=update&Name=abcd' );
