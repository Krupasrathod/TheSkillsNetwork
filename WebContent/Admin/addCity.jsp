							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<form action="<%=request.getContextPath()%>/countryController?flag=addcity" method="post" class="form-horizontal">
											<div class="form-body">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" id="stateID" readonly="readonly" name="stateCode" placeholder="Enter text">
													</div>
												</div>
											</div>
											...
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Add City Name</label>
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" name="cityName" placeholder="Enter text">
													</div>
												</div>
											</div>
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Add City Code</label>
													<div class="col-md-4">
														<input type="text" class="form-control input-circle"  name="cityCode" placeholder="Enter text">
													</div>
												</div>
											</div>
