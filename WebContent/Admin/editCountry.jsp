							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<form action="<%=request.getContextPath()%>/countryController?flag=updatecountry" method="post" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Edit Country Name</label>
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" name="countryName" value="${i.countryName}" placeholder="Enter text">
													</div>
												</div>
											</div>
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control input-circle"  name="countryCode" value="${i.countryCode}" placeholder="Enter text">
													</div>
												</div>
											</div>
