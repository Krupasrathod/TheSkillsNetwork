							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Form Description
										</div>
										
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<%=request.getContextPath()%>/formController?flag=insert" method="post" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Form Name</label>
													<div class="col-md-4">
														<input type="text" name="formName" class="form-control input-circle" placeholder="Enter text">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" name="originalName" class="form-control input-circle" placeholder="Enter text">
													</div>
												</div>
												
												<div class="form-group">
													<label class="col-md-3 control-label">Description of Name</label>
													<div class="col-md-4">
