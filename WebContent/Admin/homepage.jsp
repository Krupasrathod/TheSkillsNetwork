...
<!-- Mirrored from www.keenthemes.com/preview/metronic/theme/templates/admin4/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Oct 2015 10:02:49 GMT -->
			...
			<div class="row margin-top-10">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-yellow">${mentorCount}</h3>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display" style="width:104%;">
							<div class="number">
								<h3 class="font-purple-soft" width: 20%;>${hiringManagerCount}</h3>
