										...
										<form action="#" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" name="formName" class="form-control input-circle" placeholder="Form Name">
														
													</div>
												</div>
												
												<div class="form-group">
													<label class="col-md-3 control-label">Description of the form</label>
													<div class="col-md-4">
														<input type="text" name="description" class="form-control input-circle" placeholder="Description of the form">
														
													</div>
												</div>
												
												<div class="form-group">
													<label class="col-md-3 control-label">Original Name</label>
													<div class="col-md-4">
														<input type="text" name="originalName" class="form-control input-circle" placeholder="Original Name">
