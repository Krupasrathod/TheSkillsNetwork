...
<!-- Mirrored from www.keenthemes.com/preview/metronic/theme/templates/admin4/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Oct 2015 09:24:26 GMT -->
			...
			<div class="row margin-top-10">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-red-haze">${adminCount}</h3>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-blue-sharp">${trainerCount}</h3>
								<small>TOTAL TRAINER</small>
							</div>
							<div class="icon">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-purple-soft">${traineeCount}</h3>
								<small>TOTAL TRAINEE</small>
							</div>
							<div class="icon">
								<i class="icon-user"></i>
							</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-purple-soft">${mentorCount}</h3>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-purple-soft">${recruiterCount}</h3>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat2">
						<div class="display">
							<div class="number">
								<h3 class="font-purple-soft">${hiringManagerCount}</h3>
								<small>TOTAL HIRING MANAGER</small>
							</div>
							<div class="icon">
								<i class="icon-user"></i>
							</div>
...
<!-- Mirrored from www.keenthemes.com/preview/metronic/theme/templates/admin4/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Oct 2015 09:25:53 GMT -->
</html>