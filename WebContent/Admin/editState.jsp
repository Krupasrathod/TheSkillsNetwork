							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<c:forEach items="${sessionScope.stateid}" var="i">
										<form action="<%=request.getContextPath()%>/countryController?flag=updatestate" method="post" class="form-horizontal">
											<div class="form-body">
											<div class="form-group">
													<label class="col-md-3 control-label">State ID</label>
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" readonly="readonly" value="${i.stateID}" name="stateID" placeholder="Enter text">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
													<input type="text" class="form-control input-circle" value="${i.countryvo.countryName}" readonly="readonly" name="countryName" placeholder="Enter text">
													</div>
												</div>
												<input type="hidden" class="form-control input-circle" value="${i.countryvo.countryID}" readonly="readonly" name="countryID" placeholder="Enter text">
											
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Edit State Name</label>
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" value="${i.stateName }" name="stateName" placeholder="Enter text">
													</div>
												</div>
											</div>
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Edit State Code</label>
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" value="${i.stateCode }" name="stateCode" placeholder="Enter text">
													</div>
												</div>
											</div>
