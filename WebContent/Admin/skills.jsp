							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>User Group
										</div>
									...
									<div class="portlet-body form">
										...
										<form action="<%=request.getContextPath()%>/formController?flag=addsubjctskills" method="post" class="form-horizontal">
											<div class="form-body">
											
											<div class="form-group">
													<label class="col-md-3 control-label">Sub-subject</label>
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" id="email" name="subsubject" placeholder="Enter text">
													</div>
												</div>
														<div class="form-group">
													<label class="col-md-3 control-label"></label>
													<div class="col-md-4">
														<input type="checkbox" class="form-control input-circle" id="maincat" name="maincat" value="0">Main-Subject
													</div>
												</div>
												<div></div>
													<div id="drpdwn">											
												<div class="form-group">
													...
													<div class="col-md-4">
														...
														<select class="form-control input-circle" onchange="loademail()" id="subjct" name="subjectName">
														<option>SELECT SUBJECT</option>
														<c:forEach items="${sessionScope.subjectlist}" var="i">
												...
												<%-- <div class="col-md-4">
														...
														<select class="form-control input-circle"   name="subjectName">
														<option>SELECT SUBJECT</option>
														<c:forEach items="${sessionScope.userList}" var="i">
														<option value="${i.subjectID}">${i.subjectID}</option>
														</c:forEach>
														</select>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" id="subjectID" readonly="readonly" name="subjectID" placeholder="Enter text">
													</div>
												</div>
												</div>
