							...
							<form action="<%=request.getContextPath()%>/formController?flag=update&ID=${i.regId}"  enctype="multipart/form-data" method="post" role="form">
								...
								<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" name="firstName" class="form-control" readonly="readonly" value="${i.firstname }" placeholder="First Name" required="required">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control" readonly="readonly" name="lastname" value="${i.lastname}" placeholder="Last Name" required="required">
										</div>
										</div>
										<input type="hidden" value="${i.password}" readonly="readonly" name="password"/>
										<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" name="ContactNumber" value="${i.contactNumber}" readonly="readonly" class="form-control" placeholder="Contact Number" required="required">
										</div>
									</div>
									...
									<div class="input-icon">
										...
										<input type="text" value="${i.since}" readonly="readonly" class="form-control date-picker" name="since" id="txtfuturedate" onchange="date(this)" placeholder="Select Date"  required="required">
										</div>
									...
									<div class="input-icon">
										...
										<input type="email" value="${i.companyName}" readonly="readonly" class="form-control" name="companyName"  placeholder="Company Name" required="required">
										</div>
									</div>
									</div>
									<div class="form-group col-md-4">
									...
									<div class="input-icon">
										...
										<input type="text" value="${i.currentPosition}" readonly="readonly" class="form-control" name="currentPosition" id="exampleInputEmail22" placeholder="Current Position" required="required">
										</div>
									</div>
									</div>
								...
								<br/>
									<div class="form-group">
										...
										<div class="input-icon">
										<input type="text" name="department" value="${i.department}" readonly="readonly" class="form-control" placeholder="Department" required="required">
										</div>
									</div>
									...
									<div class="form-group">
										<label>Role</label>
										<div class="input-icon">
										<input type="text" name="role" value="${i.role}" readonly="readonly" class="form-control" placeholder="Role" required="required">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-icon">
										<input type="text" name="branchName" value="${i.branchName}" readonly="readonly" class="form-control" placeholder="Branch Name" required="required">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-icon">
										<input type="text" class="form-control" id="txtBirthDate" disabled="disabled" readonly="readonly" value="${i.dateofBirth}" name="dateofBirth" onchange="fndate(this)" placeholder="Birth Date" data-mask="99/99/9999" />
<!-- 										<input type="text" class="form-control date-picker" name="dateofBirth" size="14" id="datepicker-autoclose"  onchange="fndate(this)" placeholder="Select Date" value="" required="required"> -->
									...
									<div class="form-group">
										...
										<div class="input-icon">
										<input type="text" name="branchAddress" readonly="readonly" value="${i.branchAddress}" class="form-control" placeholder="Branch Address" required="required">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-icon">
										<input type="text" name="maritalStatus" readonly="readonly" value="${i.maritalStatus}" class="form-control" placeholder="Marital Status" required="required">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-icon">
										<input type="text" name="nationality" readonly="readonly" value="${i.nationality}" class="form-control" placeholder="Nationality" required="required">
										</div>
									</div>
									...
									<div class="form-group col-md-6">
										<div class="input-group col-md-12">
											<div class="input-icon">
											<input type="text" class="form-control" readonly="readonly" value="${i.zipCode}" name="zipCode" required="required"  placeholder="Zip Code" >
											</div>
										</div>
									</div>
									...
									<div class="form-group col-md-6">
										<div class="input-group col-md-12">
											<div class="input-icon">
											<input type="email" class="form-control" readonly="readonly" value="${i.street}" name="street"  placeholder=" Street" required="required">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label>Country</label>
											<div class="input-icon">
											<input type="text" class="form-control" readonly="readonly" value="${i.country}" name="zipCode" required="required"  placeholder="Zip Code" >
											</div>
										</div>
									...
									<div class="form-group">
										<label>City</label>
											<div class="input-icon">
											<input type="text" class="form-control" readonly="readonly" value="${i.city}" name="zipCode" required="required"  placeholder="Zip Code" >
											</div>
									...
									<div class="form-group">
										<label>Languages Known</label>
											<div class="input-icon">
											<input type="text" class="form-control" readonly="readonly" value="${i.languagesKnown}" name="zipCode" required="required"  placeholder="Zip Code" >
											</div>
									...
									<div class="form-group">
										<label>Designation</label>
											<div class="input-icon">
											<input type="text" class="form-control" readonly="readonly" value="${i.designation}" name="zipCode" required="required"  placeholder="Zip Code" >
											</div>
